...
def redrawWindow(player, tileset, mushrooms, birds):
...
#main_loop
def main():
    global player, bg, bgX, bgX2
    player = players(400,313,64,64)
    tileset = [
        sea(0,377, 64, 100),
        sea(64,377, 64, 100),
        sea(128,377, 64, 100),
    ...
    while run:
        if start_screen:
            ...
            bg1 = pygame.image.load(os.path.join(bg_path, "BG3.jpg"))
            bg1 = pygame.transform.scale(bg1, (800, 480))
            win.blit(bg1, (0, 0))
            #win.blit(player_image, (50, 150))
            Text = font1.render('Level 1', 1, (0, 0, 0))
            StartText = font1.render('Press S to start ', 1, (0, 0, 0))
            Instructions0 = font1.render('Use UP, DOWN, RIGHT buttons to play', 1, (0, 0, 0))
            Instructions1 = font1.render('Collect 50 point to pass the level', 1, (0, 0, 0))
            Instructions2 = font1.render('Each mushroom contains 5 points', 1, (0, 0, 0))
            Instructions3 = font1.render('You have 5 lives', 1, (0, 0, 0))
            Instructions4 = font1.render('Avoid birds and the sea', 1, (0, 0, 0))
            win.blit(Text, (300, 50))
            win.blit(StartText, (255, 100))
            win.blit(Instructions0, (50, 200))
            win.blit(Instructions1, (50, 250))
            win.blit(Instructions2, (50, 300))
            win.blit(Instructions3, (50, 350))
            win.blit(Instructions4, (50, 400))
            p = players(500,200, 128,128)
            p.draw_player(win)
            pygame.display.flip()
        ...
        if player.is_dead:
            font1 = pygame.font.SysFont('Calibri', 24, True, True)
            bg1 = pygame.image.load(os.path.join(bg_path, "BG1.jpg"))
            bg1 = pygame.transform.scale(bg1, (800, 480))
            win.blit(bg1, (0, 0))
            # win.blit(player_image, (50, 150))
            Text = font1.render('Game Over', 1, (0, 0, 0))
            StartText = font1.render('Press S to Start Again', 1, (0, 0, 0))
            win.blit(Text, (300, 50))
            win.blit(StartText, (250, 100))
            picture = pygame.image.load(os.path.join(char_path, "Dead__009.png"))
            picture = pygame.transform.scale(picture, (256, 256))
            win.blit(picture, (272, 100))
            #p1.is_still = False
            #p1.is_dead = True
            #p1.draw_player(win)
            pygame.display.flip()
        ...
        if player.score>=target:
            font1 = pygame.font.SysFont('Calibri', 24, True, True)
            bg1 = pygame.image.load(os.path.join(bg_path, "BG2.jpg"))
            bg1 = pygame.transform.scale(bg1, (800, 480))
            win.blit(bg1, (0, 0))
            # win.blit(player_image, (50, 150))
            Text = font1.render('Game Over. You win.', 1, (0, 0, 0))
            StartText = font1.render('Press S to Play Again and Q to proceed', 1, (0, 0, 0))
            win.blit(Text, (300, 50))
            win.blit(StartText, (250, 100))
            picture = pygame.image.load(os.path.join(char_path, "Idle__009.png"))
            picture = pygame.transform.scale(picture, (256, 256))
        ...
        redrawWindow(player, tileset, mushrooms, birds)
        ...
        if player.is_dead == False:
            ...
            for mush in mushrooms:
                ...
                if mush.collide(player.hitbox):
                    print("At line 465 " + str(mush.y))
                    print("Was" + str(player.score))
                    player.score+=5
                    print("Now" + str(player.score))
                    mush.is_visible = False
                    mushrooms.pop(mushrooms.index(mush))
