...
from Maze.Design import design
...
class Wall(pygame.sprite.Sprite):
    ...
    def __init__(self,type, x, y, width=64, height=64):
        ...
        self.image = None
        if type == 'G':
            self.image = pygame.image.load('Image/Walls/g.png').convert_alpha()
        else:
            self.image = pygame.image.load('Image/Walls/5.png').convert_alpha()
...
class Treasure(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, width = 64, height = 64):
        ...
        super().__init__()
        self.image = pygame.image.load('Image/treasure.png').convert_alpha()
...
class WaterFall(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, imageList = None, width = 64, height = 64):
        ...
        super().__init__()
        self.image = pygame.image.load('Image/Waterfall/rsz_w1001.png').convert_alpha()
...
class MiniMap(object):
    def __init__(self, win_width, win_height):
        ...
        self.image = pygame.image.load('Image/frame.png').convert_alpha()
        self.rect = self.image.get_rect()
...
class MiniWall(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load('Image/miniWall.png').convert_alpha()
...
class MiniPlayer (object):
    def __init__(self, player_abs_x = 0, player_abs_y = 0, win_width = 800, win_height = 480):
        ...
        self.image = pygame.image.load('Image/miniPlayer.png').convert_alpha()
        self.rect = self.image.get_rect()
...
playerImageLists = loadImageListInDict('Image/Player')
waterfallList = loadImageInList('Image/Waterfall')
# Load font
