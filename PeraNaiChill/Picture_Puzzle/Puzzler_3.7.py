...
def initialize():
   ...
   global color, white, black, tiles, gameWindow, level
   window_width = 800
   window_height = 480
   ...
   sprite = pygame.image.load("Idle.png")
...
def shift (c, r) :
   ...
   global emptyc, emptyr, empty_tile
   rect_color = (255,255,255)
   gameWindow.blit(
         tiles[(c, r)][0],(emptyc*tile_width, emptyr*tile_height))
   gameWindow.blit(sprite, (650, 320))
...
def start():
   ...
   level = 1
   img = img_list[level]
   image = pygame.image.load("./Res/"+img)
...
def main():
   ...
   while True:
      if game_over:
         gameWindow.blit(background, (0, 0))
         gameWindow.blit(sprite, (650, 320))
         labels(300,300,"Good job well played",(253,232,39),50)
         pygame.display.update()
         time.sleep(15)
         break
      ...
      for event in pygame.event.get():
         ...
         if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if event.dict['button'] == 1 and count == 0:
